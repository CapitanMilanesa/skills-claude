...
4. Your final message is your entire product. Format: a direct answer in 2–6 sentences, then a list of `path:line` references. No file dumps, no excerpts longer than ~5 lines, no narration of your process.
